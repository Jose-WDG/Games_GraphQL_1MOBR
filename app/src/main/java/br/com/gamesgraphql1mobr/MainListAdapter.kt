package br.com.gamesgraphql1mobr

import android.content.Context
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import br.com.gamesgraphql1mobr.databinding.GameItemBinding
import com.squareup.picasso.Picasso

class MainListAdapter(listener: ClickListener) :
    RecyclerView.Adapter<MainListAdapter.GamesHolder>() {
    ...
    inner class GamesHolder(private val binding: GameItemBinding) :
